        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
            {[
              ...
              { title: "6. Your Rights", content: "You have the right to access, correct, or delete your personal information. You may also object to processing, request portability of your data, and withdraw consent at any time. To exercise these rights, contact us at hello@softaxis.ae." },
              ...
              { title: "9. Contact Us", content: "For questions about this Privacy Policy or our privacy practices, contact us at: SoftAxis Technologies LLC, Dubai, United Arab Emirates. Email: hello@softaxis.ae" },
            ].map((section) => (
